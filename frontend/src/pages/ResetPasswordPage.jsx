      ...
      <div className="relative z-10 w-full max-w-md mx-4 animate-scale-in">
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl shadow-black/20 p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5" id="reset-password-form">
            <div>
              <label htmlFor="reset-token" className="block text-sm font-medium text-white/80 mb-1.5">
                Reset Token
              </label>
              <input
                id="reset-token"
            ...
            <div>
              <label htmlFor="reset-new-password" className="block text-sm font-medium text-white/80 mb-1.5">
                New Password
              </label>
              <input
            ...
            <div>
              <label htmlFor="reset-confirm-password" className="block text-sm font-medium text-white/80 mb-1.5">
                Confirm Password
              </label>
              <input
